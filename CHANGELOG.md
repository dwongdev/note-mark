...
- code tidy
### Added
- #262; custom css override
- #265; editor can insert asset pictures
- #266; ability to toggle random slug suffix generation
...
- bump deps
### Fixed
- dropdown causing layout shift on mobile
- IOS auto-zoom on editor
- #281; Update password fails

## [1.0.1] - 2026-06-13
### Added
- add assigned CVEs now they are allocated
### Fixed
- #275; no handling for moving notes with children
- fix folder icon rotations
